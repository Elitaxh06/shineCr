...
export default function Services({ setSelectedService }: ServicesProps) {
                ...
                >
                  ...
                  <CardFooter>
                    <button
                      ...
                      onClick={() => {
                        if (!service.disable) {
                          // Guardamos el servicio en el padre
                        ...
                        !service.disable ? scrollToCalendar() : null
                      }}

                    >
                      {!service.disable ? `Reservar ${service.name}` : "Próximamente"}
                    </button>
                  </CardFooter>
                </Card>
              )
